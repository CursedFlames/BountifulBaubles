...
import cursedflames.bountifulbaubles.forge.common.old.baubleeffect.EffectPotionNegate;
import cursedflames.bountifulbaubles.forge.common.old.baubleeffect.EffectPotionNegate.IPotionNegateItem;
...
public class ItemShieldAnkh extends ItemShieldObsidian implements IPotionNegateItem {
	...
	public ICapabilityProvider initCapabilities(ItemStack stack, CompoundTag nbt) {
		ICurio curio = new cursedflames.bountifulbaubles.forge.common.old.item.items.ankhparts.shields.ItemShieldAnkh.Curio(stack);
