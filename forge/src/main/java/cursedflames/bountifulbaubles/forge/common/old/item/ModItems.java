...
import cursedflames.bountifulbaubles.forge.common.old.item.items.ItemAmuletCross;
import cursedflames.bountifulbaubles.forge.common.old.item.items.ItemBalloon;
import cursedflames.bountifulbaubles.forge.common.old.item.items.ItemBrokenHeart;
import cursedflames.bountifulbaubles.forge.common.old.item.items.ItemDisintegrationTablet;
import cursedflames.bountifulbaubles.forge.common.old.item.items.ItemEnderDragonScale;
...
import cursedflames.bountifulbaubles.forge.common.old.item.items.ItemHorseshoeBalloon;
import cursedflames.bountifulbaubles.forge.common.old.item.items.ItemLuckyHorseshoe;
import cursedflames.bountifulbaubles.forge.common.old.item.items.ItemMagicMirror;
import cursedflames.bountifulbaubles.forge.common.old.item.items.ItemPhylacteryCharm;
import cursedflames.bountifulbaubles.forge.common.old.item.items.ItemPotionRecall;
import cursedflames.bountifulbaubles.forge.common.old.item.items.ItemPotionWormhole;
import cursedflames.bountifulbaubles.forge.common.old.item.items.ItemWormholeMirror;
...
import cursedflames.bountifulbaubles.forge.common.old.item.items.ankhparts.ItemPotionNegate;
import cursedflames.bountifulbaubles.forge.common.old.item.items.ankhparts.ItemRingFreeAction;
import cursedflames.bountifulbaubles.forge.common.old.item.items.ankhparts.ItemRingOverclocking;
import cursedflames.bountifulbaubles.forge.common.old.item.items.ankhparts.ItemSunglasses;
...
import cursedflames.bountifulbaubles.forge.common.old.misc.SimpleItemTier;
