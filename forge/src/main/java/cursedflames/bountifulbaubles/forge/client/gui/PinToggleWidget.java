...
public class PinToggleWidget extends ToggleButtonWidget {
	...
	public Identifier off = new Identifier(BountifulBaublesForge.MODID, "textures/gui/button/pin_off.png");
	public Identifier offToOn = new Identifier(BountifulBaublesForge.MODID,
			"textures/gui/button/pin_offtoon.png");
	public Identifier on = new Identifier(BountifulBaublesForge.MODID, "textures/gui/button/pin_on.png");
	public Identifier onToOff = new Identifier(BountifulBaublesForge.MODID,
